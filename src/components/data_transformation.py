## all code related to transformation of data 
import sys
import os
...
class DataTransformation:
    ...
    def get_transformer_object(self):
          try:
              ...
              logging.info("Numerical columns Standardization done!")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            # np.c_ is a NumPy shorthand used to concatenate arrays column-wise
